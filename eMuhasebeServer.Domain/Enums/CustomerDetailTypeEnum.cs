...
public sealed class CustomerDetailTypeEnum : SmartEnum<CustomerDetailTypeEnum>
{
    ...
    public static readonly CustomerDetailTypeEnum PurchaseInvoiece = new("Alış Faturası", 2);
    public static readonly CustomerDetailTypeEnum SellingInvoice = new("Satış Faturası", 2);
